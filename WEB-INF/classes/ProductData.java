 ...
 pw.println("<body>");
		...
		pw.print("<td><div id='shop_item'>");
			...
			pw.print("<li><form method='post' action='Cart'>" +
					"<input type='hidden' name='name' value='"+data.getProductId()+"'>"+
					"<input type='hidden' name='type' value='"+data.getCategory()+"'>"+
					"<input type='hidden' name='maker' value='"+data.getManufacturer()+"'>"+
